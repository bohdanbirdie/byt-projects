...
public class PersonClientsTest {
	...
	public void testClients() throws IOException {
		...
		bobSmith.toString(true, out);
		assertEquals("Bob Smith", out.toString());

		out = new StringWriter();
		jennyJJones.toString(true, out);
		assertEquals("Jenny J Jones", out.toString());

		assertEquals("Smith, Bob", bobSmith.toString(false));
		assertEquals("Jones, Jenny J", jennyJJones.toString(false));

		out = new StringWriter();
		bobSmith.toString(false, out);
		assertEquals("Smith, Bob", out.toString());

		out = new StringWriter();
		jennyJJones.toString(false, out);
